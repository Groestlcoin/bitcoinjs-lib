...
describe('Bitcoin-core', function () {
  ...
  // base58KeysValid
  describe('address.toBase58GrsCheck', function () {
    var typeMap = {
      'pubkey': 'pubKeyHash',
      'script': 'scriptHash'
    }
    ...
    base58KeysValid.forEach(function (f) {
      ...
      it('can export ' + expected, function () {
        assert.strictEqual(bitcoin.address.toBase58GrsCheck(hash, version), expected)
      })
    })
  })

  // base58KeysInvalid
  describe('address.fromBase58GrsCheck', function () {
    var allowedNetworks = [
    ...
    base58KeysInvalid.forEach(function (f) {
      ...
      it('throws on ' + string, function () {
        assert.throws(function () {
          var address = bitcoin.address.fromBase58GrsCheck(string)
